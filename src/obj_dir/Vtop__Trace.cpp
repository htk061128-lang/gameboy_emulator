...
void Vtop::traceChgSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        if (VL_UNLIKELY(vlTOPp->__Vm_traceActivity[1U])) {
            ...
            tracep->chgBit(oldp+15,(vlTOPp->top__DOT__u_CPU__DOT__IME));
            tracep->chgSData(oldp+16,(vlTOPp->top__DOT__u_CPU__DOT__PC),16);
            tracep->chgBit(oldp+17,(vlTOPp->top__DOT__cpu_mem_ena));
            tracep->chgSData(oldp+18,(vlTOPp->top__DOT__cpu_mem_ad),16);
            tracep->chgBit(oldp+19,(vlTOPp->top__DOT__cpu_mem_r_ena));
            tracep->chgBit(oldp+20,(vlTOPp->top__DOT__cpu_mem_w_ena));
            tracep->chgCData(oldp+21,(vlTOPp->top__DOT__cpu_mem_w_data),8);
            tracep->chgBit(oldp+22,(vlTOPp->top__DOT__ppu_mem_ena));
            tracep->chgSData(oldp+23,(vlTOPp->top__DOT__ppu_mem_ad),16);
            tracep->chgBit(oldp+24,(vlTOPp->top__DOT__ppu_mem_r_ena));
            tracep->chgBit(oldp+25,(vlTOPp->top__DOT__ppu_mem_w_ena));
            tracep->chgCData(oldp+26,(vlTOPp->top__DOT__ppu_mem_w_data),8);
            tracep->chgBit(oldp+27,(vlTOPp->top__DOT__dma_mem_ena));
            tracep->chgSData(oldp+28,(vlTOPp->top__DOT__dma_mem_ad),16);
            tracep->chgBit(oldp+29,(vlTOPp->top__DOT__dma_mem_r_ena));
            tracep->chgBit(oldp+30,(vlTOPp->top__DOT__dma_mem_w_ena));
            tracep->chgCData(oldp+31,(vlTOPp->top__DOT__dma_mem_w_data),8);
            tracep->chgCData(oldp+32,(vlTOPp->top__DOT__io_reg_r_data),8);
            tracep->chgBit(oldp+33,(vlTOPp->top__DOT__u_io_register__DOT__DMA_start));
